...
public class RfbLocationResourceIntTest {
    ...
    private static final Integer DEFAULT_RUN_DAY_WEEK = 1;
    private static final Integer UPDATED_RUN_DAY_WEEK = 2;
    ...
    public static RfbLocation createEntity(EntityManager em) {
        RfbLocation rfbLocation = new RfbLocation()
            ...
            .runDayWeek(DEFAULT_RUN_DAY_WEEK);
        return rfbLocation;
    }
    ...
    public void createRfbLocation() throws Exception {
        ...
        assertThat(testRfbLocation.getRunDayWeek()).isEqualTo(DEFAULT_RUN_DAY_WEEK);
    }
    ...
    public void getAllRfbLocations() throws Exception {
        ...
        restRfbLocationMockMvc.perform(get("/api/rfb-locations?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].runDayWeek").value(hasItem(DEFAULT_RUN_DAY_WEEK)));
    }
    ...
    public void getRfbLocation() throws Exception {
        ...
        restRfbLocationMockMvc.perform(get("/api/rfb-locations/{id}", rfbLocation.getId()))
            ...
            .andExpect(jsonPath("$.runDayWeek").value(DEFAULT_RUN_DAY_WEEK));
    }
    ...
    public void updateRfbLocation() throws Exception {
        ...
        updatedRfbLocation
            ...
            .runDayWeek(UPDATED_RUN_DAY_WEEK);
        ...
        assertThat(testRfbLocation.getRunDayWeek()).isEqualTo(UPDATED_RUN_DAY_WEEK);
    }
