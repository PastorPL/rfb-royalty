...
public class RfbLocation implements Serializable {
    ...
    @Column(name = "run_day_week")
    private Integer runDayWeek;
    ...
    public Integer getRunDayWeek() {
        return runDayWeek;
    }

    public RfbLocation runDayWeek(Integer runDayWeek) {
        this.runDayWeek = runDayWeek;
        return this;
    }

    public void setRunDayWeek(Integer runDayWeek) {
        this.runDayWeek = runDayWeek;
    }
